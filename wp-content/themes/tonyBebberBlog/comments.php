...
<?php else : ?>
                            ...
                            <p id="comment-notes"><?php _e('Your email is <em>never</em> published or shared.', 'your-theme') ?> <?php if ($req) _e('Required fields are marked <span class="required">*</span>', 'your-theme') ?></p>
...
<h4><a href="#comment-<?php comment_ID(); ?>"><?php comment_date('M jS, Y'); ?></a></h4>
</div>
